...
class ShopCartSerializer(serializers.Serializer):
    # 获取当前登录的用户
    # 使用serializers.Serializer原因，若使用serializers.ModelSerializer，会使用里面的验证器
    # perform_create >> serializer.save() >> serializer 的save方法
